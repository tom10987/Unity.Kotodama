...
public class TextViewer : MonoBehaviour
{
    ...
    float
        intervalForCharacterDisplay = 0.05f;  // 1文字の表示にかかる時間

    string
        currentText = string.Empty;         // 現在の文字列
    float
        timeUntilDisplay = 0.5f,                   // 表示にかかる時間
        timeElapsed = 1.0f;                        // 文字列の表示を開始した時間
    int
        currentLine = 0,                        // 現在の行番号
        lastUpdateCharacter = -1;               // 表示中の文字数
